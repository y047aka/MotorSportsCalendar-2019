...
var author$project$Main$race = A3(
...
var author$project$Main$racesDecoder = A2(
	elm$json$Json$Decode$field,
	'races',
	elm$json$Json$Decode$list(author$project$Main$race));
...
var author$project$Main$ppp = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$Recieve, author$project$Main$racesDecoder),
...
var author$project$Main$repositories = A2(
	elm$html$Html$section,
	_List_Nil,
	_List_fromArray(
		[
			...
			[
				...
				_List_fromArray(
					[
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													elm$html$Html$tbody,
													_List_Nil,
													A2(elm$core$List$map, author$project$Main$viewRaces, races))
												]));
									default:
										var error = _n0.a;
										return A2(
						...
						author$project$Main$repositories
					])),
