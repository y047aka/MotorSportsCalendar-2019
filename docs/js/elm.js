	...
	return A2(
		...
		elm$core$Task$sequence(
			A2(
				...
				getResultTask,
				_List_fromArray(
					['F1/F1_2019.json', 'FormulaE/FormulaE_2018-19.json', 'WEC/WEC_2018-19.json', 'WEC/WEC_2019-20.json', 'ELMS/ELMS_2019.json', 'IMSA/IMSA_2019.json', 'IndyCar/IndyCar_2019.json', 'NASCAR/NASCAR_2019.json', 'SuperFormula/SuperFormula_2019.json', 'SuperGT/SuperGT_2019.json', 'DTM/DTM_2019.json', 'BlancpainGT/BlancpainGT_2019.json', 'IGTC/IGTC_2019.json', 'WTCR/WTCR_2019.json', 'SuperTaikyu/SuperTaikyu_2019.json', 'WRC/WRC_2019.json', 'MotoGP/MotoGP_2019.json', 'AirRace/AirRace_2019.json']))));
}();
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotServerResponse':
				if (msg.a.$ === 'Ok') {
					var categories = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{resultChunk: categories}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								userState: author$project$Main$Loaded(races)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
...
var author$project$Main$isRaceWeek = F3(
	function (sundayPosix, races, currentPosix) {
		var racesInThisWeek = A2(
			elm$core$List$filter,
			function (raceday) {
				var racedayPosix = raceday.posix;
				var diff = A4(justinmimbs$time_extra$Time$Extra$diff, justinmimbs$time_extra$Time$Extra$Day, elm$time$Time$utc, racedayPosix, sundayPosix);
				return (diff >= 0) && (diff < 7);
			},
			races);
		var isPast = A4(justinmimbs$time_extra$Time$Extra$diff, justinmimbs$time_extra$Time$Extra$Day, elm$time$Time$utc, sundayPosix, currentPosix) > 0;
		return (elm$core$List$length(racesInThisWeek) > 0) ? author$project$Main$Scheduled(
			A2(
...
var author$project$View$links = A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.formula1.com/en/racing/2019.html'),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.fiawec.com/en/calendar/80'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.fiaformulae.com/en/championship/race-calendar'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.wrc.com/en/wrc/calendar/calendar/page/671-29772-16--.html'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('http://www.motogp.com/en/calendar'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.indycar.com/Schedule'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://sportscarchampionship.imsa.com/schedule-results/race-schedule'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://www.nascar.com/monster-energy-nascar-cup-series/2019/schedule/'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://supergt.net/races'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$href('https://superformula.net/sf2/en/race2019/'),
									elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
...
var author$project$View$repositories = A2(
	elm$html$Html$section,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$View$siteFooter = A2(
...
var author$project$View$siteHeader = A2(
